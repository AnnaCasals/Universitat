...
public class Hospital {
    ...
    public static int MAX_PACIENTS = 5000;
    /** Constant que representa el numero maxim de llits de 
     *  qualsevol hospital. */
    public static int MAX_LLITS = 200;
    ...
    private int cercar(String nif) {
        int i = 0;
        while(i < historic.length && !nif.equals(historic[i])) {
            i++;
        }
        if(i < historic.length) { return i; }
        else { return -1; }
    }
