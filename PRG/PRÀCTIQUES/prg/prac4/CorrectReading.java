    ...
    public static double nextDoublePositive(Scanner keyboard, String message) {
        ...
        do {
            try{
                ...
                System.out.println("Per favor, introduiu un número real correcte! ...");
            } finally {
                keyboard.nextLine();
            }
        } while (value < 0.0);
    ...
    public static int nextInt(Scanner keyboard, String message) {
        ...
        do {
            try {
                ...
                System.out.println("Per favor, introduiu un enter correcte! ...");
            } finally {
                keyboard.nextLine();
            }
        ...
        do {
            try{
                ...
                if(value < lowerBound || value > upperBound) {
                    throw new IllegalArgumentException("El número ha d'estar en el rang adequat");
                }
                someError = false;
            } catch (InputMismatchException e) {
                System.out.println("Per favor, escriu un número enter correcte! ...");
