 ...
 * v√†lida de dades de tipus primitius des de l'entrada est√†ndard.
 * @author PRG 
...
public class LecturaValida {
     ...
     * @param missatge String per a peticiÛ de valor.
    ...
    public static int llegirInt(Scanner tec, String missatge) {
        ...
        do {
            try {
                ...
                System.out.println("Asegura't d'introduir un enter v‡lid!"
                                   + " Intenta-ho de nou ...");   
            } finally {
                tec.nextLine();
            }
     ...
     * @param tec Scanner per a lectura des de teclat.
     * @param missatge String per a peticiÛ de valor.
     * @param lInferior int que indica el lÌmit inferior de l'interval
     * de lectura.
     * @param lSuperior int que indica el lÌmit superior de l'interval
     * de lectura.
