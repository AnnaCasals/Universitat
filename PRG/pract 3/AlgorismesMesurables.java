/** Classe AlgorismesMesurables: classe d'utilitats amb els mètodes a analitzar.
 * @author PRG - ETSInf
...
public class AlgorismesMesurables {
     ...
     *  @return int, posició d'e en a o -1 si e no està en a
     */
    ...
    /** Mètode d'ordenació per selecció
     *  @param a int[], array d'enters
     */
    ...
    /** Mètode d'ordenació per inserció
     *  @param a int[], array d'enters
     */
    ...
    /** mergeSort: mètode d'ordenació
     *  @param a int[], array d'enters
     *  @param i int, posició inicial a considerar
     *  @param f int, posició final a considerar
     */ 
     ...
     *  @param i int, posició inicial a considerar
     *  @param f int, posició final a considerar
     *  @param h int, posició meitat a considerar
     */ 
